...
urlpatterns = [
    path('verificarVotante/', views.VerificarVotante.as_view(), name='verificacion-votante'),
    ...
    path('agradecimiento/', views.ErrorVotante.as_view(), name='agradecimiento-votante'),
